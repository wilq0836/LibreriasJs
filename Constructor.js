...
const productosScott = [
    {marca:"scott",modelo:"addictrc",precio:12000000,especificacion:"nueva",foto:"./img/addictrc10.jpg"},
    {marca:"scott",modelo:"addictrc",precio:10000000,especificacion:"nueva",foto:"./img/addictrc20.jpg"},
...
const productosGiant = [
    ...
    {marca:"Giant",modelo:"addict",precio:10000000,especificacion:"nueva",foto:"./img/propeladvance.jpg"},
    {marca:"Giant",modelo:"addict",precio:10000000,especificacion:"nueva",foto:"./img/propelgray.jpg"}
...
//const contenedor = document.getElementById("contenedor10");
...
function impri (){ 
    ...
    productos.forEach((item)=>{            
        ...
        botonAgregar.onclick = () => {            
           ...
           //let productoAgregado =  carrito.find((elem) => elem.item.id == item.id);
           carrito.push( new Bicicleta(item.marca, item.modelo, item.precio));           
